...
import { LoanApplicationError, getMyApplications } from "../../services/loanApplicationService";
...
export default function MyApplicationsPage() {
  ...
  function loadApplications() {
    ...
    getMyApplications()
      ...
      .catch((err) =>
        setLoadError(err instanceof LoanApplicationError ? err.message : "Could not load your applications.")
      )
      ...
      <div className="admin-card">
        ...
        {showWizard ? (
          <>
            ...
            <button type="button" className="link-button" onClick={() => setShowWizard(false)}>
          ...
          <p className="master-data-empty">You haven't submitted any applications yet.</p>
        ) : (
            ...
            <tbody>
              {applications.map((app) => (
                <tr key={app.id}>
                  ...
                  <td>₹{app.requestedAmount.toLocaleString("en-IN")}</td>
                  <td>
